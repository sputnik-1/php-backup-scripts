...
# last updated: Fri Apr  4 20:57:08 BST 2008

# PHP script to backup the RPM database file to /backup/rpm-database
...
$SOURCE_FILE="/var/lib/rpm/Packages";
...
# shell command to copy RPM database to backup partition 
...
# $bash_command = `diff -r $SOURCE_FILE $DESTINATION_DIR/Packages`;
# echo "$bash_command \n";
